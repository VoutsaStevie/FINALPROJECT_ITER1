...
<body><noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-THQTXJ7" height="0" width="0"
                ...
                <div class="row justify-content-center form-bg-image"
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="{{url('dologin')}}" class="mt-4" method="post">
                                @csrf
    ...
    <script>
        (function() {
            var js =
                "window['__CF$cv$params']={r:'7bea8b48f98c37c7',m:'f3tA_rCE9qFq8iMt2ivLt03MSzX.vgmIteYXJhu2VPY-1682634983-0-ARoZFhJDXAZw7X6D7xNhkp60HKq%2bCZh3FMa0j37kAHP/index.html',u:'/cdn-cgi/challenge-platform/h/g'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='https://demo.themesberg.com/cdn-cgi/challenge-platform/scripts/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"7bea8b48f98c37c7","version":"2023.3.0","r":1,"b":1,"token":"3a2c60bab7654724a0f7e5946db4ea5a","si":100}'
