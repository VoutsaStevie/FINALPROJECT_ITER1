<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demo.themesberg.com/volt-pro/pages/examples/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 22:36:52 GMT -->
<!-- Added by HTTrack -->
...
<body><noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-THQTXJ7" height="0" width="0"
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                                    ...
                                    <div class="form-group mb-4"><label for="confirm_password">Confirm Password</label>
                                        <div class="input-group"><span class="input-group-text" id="basic-addon2"><svg
                                                    ...
                                                    <path fill-rule="evenodd"
                                                        d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"
                                                        clip-rule="evenodd"></path>
                                                </svg> </span><input type="password" placeholder="Confirm Password"
                                                class="form-control" id="confirm_password" required></div>
                                    </div>
                                    <div class="mb-4">
                                        <div class="form-check"><input class="form-check-input" type="checkbox" value=""
                                                id="remember">
                                            <label class="form-check-label fw-normal mb-0" for="remember">I agree to the
                                                <a href="#" class="fw-bold">terms and conditions</a></label></div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-center my-4"><a href="#"
                                    ...
                                    aria-label="facebook button" title="facebook button"><svg class="icon icon-xxs"
                                    ...
                                    aria-label="twitter button" title="twitter button"><svg class="icon icon-xxs"
                                    ...
                                    aria-label="github button" title="github button"><svg class="icon icon-xxs"
    ...
    <script>
        (function() {
            var js =
                "window['__CF$cv$params']={r:'7bea8ba87e3337c7',m:'hjdD2KQXm2vg6f8q.ZreBbdOk_hEtgs6K8a7b9Ew5y0-1682634999-0-ASn0kpZz91P+Dxj/LYF8pspAVo7zZ9iDLfHPuP9oUNc3',u:'/cdn-cgi/challenge-platform/h/g'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='https://demo.themesberg.com/cdn-cgi/challenge-platform/scripts/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"7bea8ba87e3337c7","version":"2023.3.0","r":1,"b":1,"token":"3a2c60bab7654724a0f7e5946db4ea5a","si":100}'
